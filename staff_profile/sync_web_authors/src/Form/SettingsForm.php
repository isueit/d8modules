    ...
    */
    public function buildForm(array $form, FormStateInterface $form_state) {
      ...
      $form['sync_url'] = array(
        ...
        '#description' => $this->t('URL of JSON feeds for sync. Use %20 instead of spaces. Examples: https://www.extension.iastate.edu/staff/feeds/cty-authors/dallas or https://www.extension.iastate.edu/staff/feeds/site-authors/4H'),
        '#size' => 64,
