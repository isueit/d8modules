    ...
    */
    public function buildForm(array $form, FormStateInterface $form_state) {
      ...
      $form['sync_url'] = array(
        ...
        '#description' => $this->t('URLs of JSON feeds to populate staff for this site. Use %20 instead of spaces, ie black%20hawk <br> Examples: https://www.extension.iastate.edu/staff/feeds/team/digital%20ag, https://www.extension.iastate.edu/staff/feeds/county/linn <br>Separate each url with a new line'),
        '#size' => 64,
