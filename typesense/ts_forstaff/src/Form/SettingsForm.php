...
namespace Drupal\ts_forstaff\Form;
...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('ts_forstaff.settings');
    ...
    $form['collection'] = [
      ...
      '#size' => 50,
      '#maxlength' => 100,
      '#default_value' => empty($config->get('collection')) ? 'ForStaff' : $config->get('collection'),
      '#required' => true,
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state)
  {
    ...
    $this->config('ts_forstaff.settings')
